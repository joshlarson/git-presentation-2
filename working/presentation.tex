...
\title{Gitshop Workhub}
\subtitle{(re)Based on a True Story}
\author{Josh Larson}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \uncover<6-> {
        ...
        \branch{main}{(2.5, 1)}{main}
        \draw (main) -- (commit7);
      }

      \uncover<1-3>{
        \branch{main}{(-5, 1)}{main}
        \draw (main) -- (commit1);
      }
      
      \uncover<4-5>{
        \branch{main}{(0, 1)}{main}
        \draw (main) -- (commit3);
      }
...
\begin{frame}
  \begin{center}
    \begin{tikzpicture}
      ...
      \uncover<1-5>{
        \branch{remotemain}{(-2, 2.5)}{main}
        \draw (remotemain) -- (remotecommit2);
      }
      \uncover<6->{
        \branch{remotemain}{(0, 2.5)}{main}
        \draw (remotemain) -- (remotecommit3);
      }
      ...
      \uncover<4-7>{
        \branch{originmain}{(-2, -2.5)}{origin/main}
        \draw (originmain) -- (localcommit2);
      }
      \uncover<8->{
        \branch{originmain}{(0, -2.5)}{origin/main}
        \draw (originmain) -- (localcommit3);
      }

      \uncover<5-10>{
        \branch{localmain}{(-2, -0.5)}{main}
        \draw (localmain) -- (localcommit2);
      }
      \uncover<11->{
        \branch{localmain}{(0, -0.5)}{main}
        \draw (localmain) -- (localcommit3);
      }
      ...
      \uncover<10>{\textbox{}{(0, 0)}{\texttt{git merge origin/main}}}
    \end{tikzpicture}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \item Don't do it on \texttt{main}
...
\begin{frame}
  \begin{center}
    \begin{tikzpicture}
      ...
      \uncover<4>{\textbox{}{(0, 4)}{\texttt{git diff main..foo}}}
      \uncover<5>{\textbox{}{(0, 4)}{\texttt{git diff main...foo}}}
      ...
      \uncover<19>{\textbox{}{(0, 4)}{\texttt{git diff main..bar spec}}}
      \uncover<20>{\textbox{}{(0, 4)}{\texttt{git diff main..bar spec | git apply}}}
      \uncover<21>{\textbox{}{(0, 4)}{\texttt{git diff main..bar spec > blah.patch}}}
    ...
    \begin{tikzpicture}
      ...
      \uncover<2-6, 19-20>{
        \textbox{}{(-3, 2)}{
          ...
          \texttt{\textcolor{gray}{------------}}\\
          \texttt{\ This is}\\
          \texttt{\textcolor{gray}{\ very}}\\
          \texttt{\textcolor{gray}{\ insightful}}\\
          \texttt{\ code}
        }
      }      
      ...
      \uncover<21-29>{
        \textbox{}{(-3, 2)}{
          ...
          \texttt{\ This is}\\
          \texttt{\textcolor{gray}{\ very}}\\
          \texttt{\textcolor{blue}{\ insightful}}\\
          \texttt{\ code}
        }
      }      
      ...
      \uncover<3-4, 9, 26-27>{\textbox{}{(0, 0)}{\texttt{git diff}}}
      \uncover<10-11, 23-24>{\textbox{}{(0, 0)}{\texttt{git diff --cached}}}
      \uncover<6-7>{\textbox{}{(0, 0)}{\texttt{git add .}}}
      \uncover<20-21>{\textbox{}{(0, 0)}{\texttt{git add -p}}}
      \uncover<13-14, 29-30>{\textbox{}{(0, 0)}{\texttt{git commit}}}
      \uncover<32-33>{\textbox{}{(0, 0)}{\texttt{git commit -a}}}
      
      \uncover<4, 11>{
        \textbox{}{(3, 2)}{
          \texttt{\ \ This is}\\
          \texttt{\textcolor{green}{+ very}}\\
          \texttt{\textcolor{green}{+ insightful}}\\
          \texttt{\ \ code}
        }
      }      
      ...
      \uncover<1-13, 16, 19-29>{
        \selectedanoncommit{main}{(-4.5, -2)}
      }
      \uncover<14-15, 17-18, 30->{
        \anoncommit{}{(-4.5, -2)}
      }

      \uncover<14-15, 17, 30-32>{
        \selectedanoncommit{addinsightful}{(0, -2)}
        \draw (main) -- (addinsightful);
      }
      \uncover<14-15, 18, 33->{
        \anoncommit{addinsightful}{(0, -2)}
        \draw (main) -- (addinsightful);
      }

      \uncover<18, 33-34>{
        \selectedanoncommit{addvery}{(4.5, -2)}
        \draw (addinsightful) -- (addvery);
      }
    \end{tikzpicture}
  \end{center}
\end{frame}
